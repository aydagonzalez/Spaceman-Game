console.log( "ARE YOU THERE?")
  /*----- constants -----*/
   ...
   // const guessLimit =  //this will set # of total guess limit
// 
...
// -alphabet as an array -> use forEach method
  ...
  /*----- state variables -----*/
//guessCount; {
  //pG: 0, // # total 'p' player guesses cout
  //wG: 0, // # player "w" wrong guesses count

//wordCount ; // how many letters left to guess 
